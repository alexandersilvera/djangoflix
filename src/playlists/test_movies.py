...
class MovieProxyTestCase(TestCase):
    def create_videos(self):
        ...
        video_b = Video.objects.create(title='This is my video', video_id='abc1234')
        video_c = Video.objects.create(title='This is my video', video_id='abc1235')
    ...
    def test_publish_manager(self):
        ...
        self.assertEqual(published_qs.count(), self.publish_item_count)
