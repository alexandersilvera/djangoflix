...
class TaggedItemTestCase(TestCase):
    def setUp(self):
        ...
        self.ply_obj.tags.add(TaggedItem(tag='nuevo-tag'), bulk=False)
        self.ply_obj2.tags.add(TaggedItem(tag='nuevo-tag'), bulk=False)
    ...
    def test_related_field_create(self):
        self.ply_obj.tags.create(tag='este-nuevo-tag')
